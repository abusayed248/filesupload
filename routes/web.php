...
Route::get('/magic-view}', [MagicLinkController::class, 'magiLinkView'])->name('magic-view');
Route::middleware('auth:sanctum')->get('/contact', [MagicLinkController::class, 'contactView'])->name('contact');
Route::middleware('auth:sanctum')->get('/', [MagicLinkController::class, 'loginWithMagicLink'])->name('login');
