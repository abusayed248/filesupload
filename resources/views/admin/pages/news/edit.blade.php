        ...
        <div class="col-md-6 card-body">
            <form action="{{ route('update.news', $news->id) }}" method="POST">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control border" id="title" name="title" value="{{ $news->title }}" required>
                </div>

                <div class="mb-3">
                    <label class="form-label" for="inputEmail">Body</label>
                    <div id="quill-editor" class="mb-3" style="height: 300px;"> </div>
                    <textarea rows="3" class="mb-3 d-none" name="description" id="quill-editor-area">{{ old('description', $news->description) }}</textarea>
                </div>
...
<script type="text/javascript">
    document.addEventListener('DOMContentLoaded', function() {
        if (document.getElementById('quill-editor-area')) {
            ...
            var descriptionContent = `{!! old('description', $news->description ?? '') !!}`;
