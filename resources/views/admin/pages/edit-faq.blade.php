        ...
        <div class="col-md-6 card-body">
            <form action="{{ route('update.faq', $faq->id) }}" method="POST">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control border" id="title" value="{{ $faq->title }}" name="title" required>
                </div>

                <div class="mb-3">
                  <label for="description" class="form-label">Description</label>
                  <textarea type="text" class="form-control border" id="description" name="description" required>{{ $faq->description }}</textarea>
                </div>
