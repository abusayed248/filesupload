    ...
    <script type="text/javascript">
        ...
        resumable.on('fileAdded', function(files) {
            showProgress();
                ...
                resumable.upload(); // Upload each file individually
        ...
        resumable.on('fileSuccess', function(file, response) { // trigger when file upload complete
            ...
            if (response.mime_type.includes("image")) {
                ...
                imagePreview.src = response.path + '/' + response.name;
                imagePreview.classList.add('col-md-3', 'mb-2'); // Adjust class for layout
